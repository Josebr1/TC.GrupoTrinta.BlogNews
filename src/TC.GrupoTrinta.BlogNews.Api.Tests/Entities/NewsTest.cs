...
public class NewsTest {
  ...
  [Theory(
      DisplayName =
          "Lança uma exceção se a data de publicação for anterior à data atual")]
  [Trait("News", "Validando operações")]
  [InlineData("Faculdade Fiap", "Faculdade de Tecnologia", "Grupo Trinta")]
  public void NewsProperties_SetAndGetProperties_WorkAsExpected(string title,
                                                                string content,
                                                                string author) {
    // arrange
    ...
    Assert.Throws<DomainExceptionValidation>(
        () => new News(title, content, author, dateNow));
  }

  [Fact(
      DisplayName =
          "Verifica se um título com o tamanho mínimo permitido (5 caracteres) é validado com sucesso")]
  [Trait("News", "Validando operações")]
  public void NewsTitle_MinimumLength_PassesValidation() {
    ...
    // act
    var news =
        new News("Maria", data.Content, data.Author, data.PublicationDate);
  ...
  [Fact(
      DisplayName =
          "Confirma se um título com o tamanho máximo permitido (255 caracteres) é validado com sucesso")]
  [Trait("News", "Validando operações")]
  public void NewsTitle_MaximumLength_PassesValidation() {
    ...
    // act
    var news = new News(
        "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has ss",
        data.Content, data.Author, data.PublicationDate);
  ...
  [Fact(
      DisplayName =
          "Testa se um título com menos de 5 caracteres lança uma exceção de domínio")]
  [Trait("News", "Validando operações")]
  ...
  [Fact(DisplayName =
            "Título com mais de 255 caracteres lança uma exceção de domínio")]
  [Trait("News", "Validando operações")]
